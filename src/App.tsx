    ...
    <div className='h-full bg-slate-900 text-slate-200 text-xl text-center flex flex-col'>
      <div className='h-full grid place-content-center'>
        <div className='flex flex-col gap-8'>
          <h1 className='text-xl'>wysi countdown</h1>
          <span>
            <span className='font-bold flex flex-col text-4xl'>
      ...
      <footer className='text-slate-400 border-t border-slate-500 p-4 grow-0 shrink text-md'>
        by Matthew Li, <a
